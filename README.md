...
2.	Conecte en serie cada juego de resistores mostrado en la figura 5-67 entre los puntos A y B.
...
4. En la tarjeta de circuito impreso de doble cara mostrada en la figura 5-69, identifique cada grupo de resistores en serie. Observe que muchas de las interconexiones de la tarjeta van de la cara anterior a la cara posterior.
...
6.	La corriente suministrada por la fuente en la figura 5-70 es de 5 mA. ¿Cuánta corriente indica cada miliamperímetro localizado en el circuito?
...
10. Encuentre la resistencia total de los siguientes grupos de resistores en serie:
...
12. ¿Cuál es la resistencia total de doce resistores de 5.6 kΩ dispuestos en serie?
...
16. En la figura 5-71, encuentre la resistencia total si los tres circuitos están conectados en serie.
...
18. ¿Cuál es la corriente presente en cada circuito de la figura 5-74?
...
20. Se conectan tres resistores de 470 Ω en serie con una fuente de 48 V.
...
22. ¿Cuál es el valor de cada resistor mostrado en la figura 5-75?
...
24. En el circuito de la figura 5-77, el medidor lee 7.84 mA cuando el interruptor está en la posición A.
...
26. Ayuda en serie es un término utilizado en ocasiones para describir fuentes de voltaje de la misma polaridad en serie. Si una fuente de 5 V y otra de 9 V están conectadas de esta manera, ¿cuál es el voltaje total?
...
28. Determine el voltaje de fuente total en cada circuito de la figura 5-79.
...
30. Cinco resistores están dispuestos en serie con una fuente de 20 V. Las caídas de voltaje a través de cuatro de los resistores son: 1.5 V, 5.5 V, 3 V, y 6 V. ¿Cuál es la caída de voltaje en el quinto resistor?
...
32. En el circuito de la figura 5-81, determine la resistencia de R4.
...
34. Determine el voltaje a través de R5 para cada una de las posiciones del interruptor de la figura 5-83. La corriente en cada posición es como sigue: A, 3.35 mA; B, 3.73 mA; C, 4.50 mA; D, 6.00 mA.
...
36. La resistencia total de un circuito es de 560 Ω. ¿Qué porcentaje del voltaje total aparece a través de un resistor de 27 Ω que forma parte de la resistencia total en serie?
...
38. Determine el voltaje con respecto a tierra para las salidas A, B y C en la figura 5-85(a)
...
40. ¿Cuál es el voltaje a través de cada resistor mostrado en la figura 5-86? R es el resistor de valor más
...
42. Si hay 10 V a través de R1 en la figura 5-88, ¿cuál es el voltaje en cada uno de los demás resistores?
...
44. Diseñe un divisor de voltaje variable para producir un voltaje de salida ajustable desde un mínimo de
...
46. ¿Cuál es la potencia total en el circuito de la figura 5-88? Use los resultados del problema 43
...
48. Encuentre RT en la figura 5-89.
...
50. En la figura 5-90, determine el voltaje en cada punto con respecto a tierra
...
52. En la figura 5-91, determine el voltaje en cada punto con respecto a tierra.
...
54. Observe los medidores de la figura 5-92 y determine los tipos de fallas ocurridos en los circuitos y qué
...
56. La tabla 5-1 muestra los resultados de mediciones de resistencia efectuadas en la tarjeta de circuito impreso que aparece en la figura 5-93. ¿Son correctos estos resultados? Si no, identifique los posibles problemas.
...
58. Al examinar la tarjeta de circuito impreso de la figura 5-93, se miden 17.83 kÆ entre las puntas 1 y 2.
...
2. Muestre cómo conectar los resistores de la figura 6-65(a) en paralelo entre las terminales de una batería.
...
4. Identifique los grupos de resistores que están en paralelo en la tarjeta de circuito impreso de doble cara mostrada en la figura 6-66.
...
6. El voltaje de fuente en la figura 6-67 es de 100 V. ¿Cuánto voltaje lee cada uno de los medidores?
...
8. ¿Cuál es el voltaje entre los extremos de cada resistor incluido en la figura 6-68 para cada posición del
interruptor?
...
10. Se leen las siguientes corrientes en la misma dirección en un circuito de tres ramas en paralelo: 250 mA,
...
12. En el circuito de la figura 6-69, determine la resistencia en R2, R3 y R4.
...
14. La resistencia total de un circuito en paralelo es de 25 ohmios. ¿Cuál es la corriente a través de un resistor
...
16. Encuentre la resistencia total de cada uno de los siguientes grupos de resistores en paralelo:
...
18. ¿Cuál es la resistencia total de doce resistores de 6.8 kΩ dispuestos en paralelo?
...
20. Encuentre la resistencia total de todo el circuito en paralelo descrito en el problema 18.
...
22. ¿Cuál es la resistencia total entre el punto A y tierra en la figura 6-72 en las siguientes condiciones?
...
24. Tres resistores de 33 Ω están conectados en paralelo con una fuente de 110 V. ¿Cuál es la corriente suministrada por la fuente?
...
26. Muchos tipos de luces decorativas están conectados en paralelo. Si se conecta un juego de luces a una fuente de 110 V y si la resistencia en caliente del filamento de cada foco es de 2.2 kΩ, ¿cuál es la corriente a través de cada foco? ¿Por qué es mejor tener estos focos en paralelo y no en serie?

**Respuesta:**

50 mA; Cuando un foco se funde, los demás focos permanecen encendidos.

28. ¿A qué valor mínimo se puede ajustar el reóstato de 100 Ω mostrado en la figura 6-75 antes de que el fusible de 0.5 A se funda?
...
30. Encuentre los valores de las cantidades no especificadas en la figura 6-77.
...
32. Determine la corriente a través del resistor para cada una de las posiciones de interruptor calibradas en la figura 6-79.
...
34. Determine la corriente en cada uno de los divisores de corriente mostrados en la figura 6-81.
...
36. Determine todos los valores de resistor en la figura 6-83. RT =773 Ω.
...
38. En el mercado están disponibles resistores en derivación especialmente diseñados para detectar caídas de voltaje de 50 mV en aplicaciones de medición de corrientes altas. Se conecta un voltímetro de 50 mV, 10 kΩ de escala completa entre la derivación para realizar la medición.
...
40. Determine la potencia total en cada uno de los circuitos de la figura 6-81.
...
42. Encuentre los valores de las cantidades no especificadas en la figura 6-84.
...
44. Si en el problema 40 se funde uno de los focos, ¿cuánta corriente circulará a través de cada foco restante? ¿Cuál será la corriente total?

**Repuesta:**

682 mA, 3.41 A

46. ¿Qué está mal con el circuito de la figura 6-86?
...
48. Desarrolle un procedimiento de prueba para revisar la tarjeta de circuito mostrada en la figura 6-87 y asegurarse de que no hay componentes abiertos. Debe realizar esta prueba sin quitar el componente de la tarjeta. Describa el procedimiento en un formato detallado paso a paso.
...
50. Para el circuito mostrado en la figura 6-88, determine la resistencia entre las siguientes puntas si existe un corto entre las puntas 3 y 4:
